########## 1. 반도체 분야 주식 종목명, 종목코드 데이터프레임 구축
import pandas as pd
...
# DataFrame 생성 시 인덱스와 컬럼명 지정
semiconductor_df = pd.DataFrame(list(semiconductor_stock_code_dict.items()), columns=['stock_code', 'stock_name'])
semiconductor_df.to_csv("semiconductor_stock_list.csv",index=False)